...
int main()
{
    ...
    else
    {
        ...
        {
            if (runners_time[0] > runners_time[2])
            {
        ...
        else if (runners_time[1] > runners_time[2])
        {
            if (runners_time[1] > runners_time[0])
            {
        ...
        else if (runners_time[2] > runners_time[0])
        {
            if (runners_time[2] > runners_time[1])
            {
